...
// Third-party login buttons component
  ...
  return (
    <div className="space-y-3">
      ...
      <button
        ...
        className={`
          w-full flex items-center justify-center px-4 py-2 border border-neutral-300 dark:border-neutral-600 
      ...
      <button
        ...
        disabled={loading !== null}
        className={`
          w-full flex items-center justify-center px-4 py-2 border border-neutral-900 dark:border-neutral-600 
      ...
      <button
        ...
        disabled={loading !== null}
        className="w-full flex items-center justify-center px-4 py-2 border border-green-500 rounded-md shadow-sm text-sm font-medium text-white bg-green-500 hover:bg-green-600 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-green-500 disabled:opacity-50 disabled:cursor-not-allowed"
      >
        <svg className="w-5 h-5 mr-2" viewBox="0 0 24 24" fill="currentColor">
